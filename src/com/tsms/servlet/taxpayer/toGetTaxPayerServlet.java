...
/**
 * Servlet implementation class toGetTaxPayerServlet
 */
@WebServlet("/toGetTaxPayerServlet.action")
public class toGetTaxPayerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public toGetTaxPayerServlet() {
        super();
