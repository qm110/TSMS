					...
					<table class="kv-table" id="addPayer">
						<tbody>
							...
							<tr>
								...
								<input type="radio" name="sex" class="easyui-validatebox" placeholder="女" value="0"> 女</td>
							...
							<tr>
								...
								<td class="kv-content"><select name="organId" id="selectOrgan" class="easyui-validatebox" data-options="validType:'choose'" >
...
$("input[name=birthday]").datebox({
	...
	//添加纳税人
		$("#savePayer").click(function(){
			...
			$.post("../../toAddTaxerServlet.action",$("#addForm").serialize(),function(data){			
				if(data.success){
