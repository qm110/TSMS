                   ...
                   <li>             	
                     ...
                     <li>
                        ...
                        <ul class="sider-nav-s">
                            ...
                            <li><a href="javascript:addTab('调查任务录入','../../manage/jsp/addTask2.jsp')">调查任务录入</a></li>
	...
	$(function() {
    	...
    	$(".userInfo").click(function(){
    			$("#topWindow").window({
    				...
    				width:800,
    				height:300,
    				content:"<iframe scrolling='no' width='100%' height='100%' src='../../toGetUserInfoServlet.action?username=${username}'></iframe>"
    			})
    	})
